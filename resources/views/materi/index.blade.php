  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="grid gap-x-4 gap-y-8 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-4">
      ...
      @forelse($materis as $materi)
        <!-- materi card - start -->
        <div>
          <div class="group relative mb-2 block h-64 overflow-hidden rounded-lg bg-blue-50 shadow-lg hover:shadow-2xl transition-all lg:mb-3">
            ...
            <a href="{{ asset('storage/' . $materi->file_path) }}" download
              ...
              <span class="mb-4 inline-flex items-center gap-2 rounded-full bg-blue-600 px-4 py-2 text-white font-bold shadow hover:bg-blue-800 text-sm transition">
          ...
          <div>
            ...
            <div class="flex items-center gap-2 text-xs text-gray-400">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 4h10a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V9a2 2 0 012-2zm2 4h4" />
              </svg>
