...
<div class="relative flex flex-col items-center justify-center min-h-[80vh]">
    ...
    <div class="relative w-full max-w-md px-6 py-10 bg-white/90 backdrop-blur-lg rounded-2xl shadow-2xl border border-blue-100 space-y-7
        ...
        <p class="text-center text-gray-500 text-sm mb-4">Mulai petualangan belajarmu! Pilih jenis test & level yang sesuai 👇</p>
        <form action="{{ route('quiz.start') }}" method="POST" class="space-y-6 mt-4">
            ...
            <div>
                ...
                <div class="flex items-center justify-center gap-8">
                    <label class="flex flex-col items-center cursor-pointer">
                        <span class="bg-blue-50 border border-blue-200 rounded-full p-3 mb-2 transition hover:bg-blue-100">
                            <img src="{{ asset('images/rewind.png') }}" alt="Pretest Icon" class="h-6 w-6 object-contain text-blue-600">
                        </span>
                    ...
                    <label class="flex flex-col items-center cursor-pointer">
                        <span class="bg-purple-50 border border-purple-200 rounded-full p-3 mb-2 transition hover:bg-purple-100">
                            <img src="{{ asset('images/after.png') }}" alt="Posttest Icon" class="h-6 w-6 object-contain text-purple-600">
                        </span>
            ...
            <div>
                ...
                <select id="level" name="level" required class="block w-full px-4 py-3 rounded-lg border-2 border-blue-100 bg-blue-50 focus:ring-2 focus:ring-blue-300 focus:outline-none text-blue-700 font-semibold">
            ...
            <button type="submit" class="w-full py-3 rounded-xl bg-gradient-to-tr from-blue-500 to-sky-400 text-white font-bold shadow-lg hover:from-blue-600 hover:to-sky-500 transition transform hover:-translate-y-1">Mulai Quiz</button>
        </form>
    </div>
</div>
